<x-kitchen-layout>
  <div>
    <div class="header flex items-center justify-between">
      <div class="welcome">
        <h1 class="text-2xl font-bold uppercase text-gray-500">Dashboard</h1>
    ...
    @php
      ...
      $categories = App\Models\MealCategory::count();
      $foods = App\Models\Menu::count();
    @endphp
    <div class="mt-10 bg-gray-600 p-2 flex rounded-xl shadow-lg">
      <div class="grid grid-cols-4  py-10 w-full gap-4">
        ...
        {{-- <div class="bg-white relative border rounded-2xl p-4">
          ...
          <h1 class="font-semibold mt-3 text-3xl text-green-700">1</h1>
        </div> --}}
        <div class="bg-white relative border rounded-2xl p-4">
          <div class="absolute -top-7 h-10 w-10 rounded-xl grid place-content-center bg-green-500 border-4 border-white">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="fill-white" width="24"
          ...
          <h1 class="font-semibold text-xl text-gray-700">TOTAL CATEGORIES</h1>
          <h1 class="font-semibold mt-3 text-3xl text-green-700">{{ $categories }}</h1>
        </div>
        <div class="bg-white relative border rounded-2xl p-4">
          <div
            class="absolute -top-7 h-10 w-10 rounded-xl grid place-content-center bg-green-500 border-4 border-white">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="fill-white" width="24"
              height="24">
              <path fill="none" d="M0 0h24v24H0z" />
              <path
          ...
          <h1 class="font-semibold text-xl text-gray-700">TOTAL FOOD</h1>
