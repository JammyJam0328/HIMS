    ...
    <div
        ...
        <div class="space-y-6 lg:col-span-2 lg:col-start-1">
            ...
            <section aria-labelledby="applicant-information-title">
                <div class="bg-white border-b border-x">
                    <div class="flex px-4 py-5 space-x-2 sm:px-6">
                        <h2 id="applicant-information-title"
                            class="text-sm font-medium leading-6 text-gray-700">Legend: </h2>
                        <span
                ...
                {{-- <div class="grid grid-cols-1 gap-3 px-2 mt-4 xl:grid-cols-2">
          <div class="border h-36 rounded-3xl">
        ...
        <section aria-labelledby="timeline-title"
            ...
            <div class="px-4 py-5 bg-white shadow sm:rounded-lg sm:px-6">
                <h2 id="timeline-title"
                    class="text-lg font-medium text-gray-900">Timeline</h2>
                ...
                <div class="flex flex-col mt-6 justify-stretch">
                    <button type="button"
                        class="inline-flex items-center justify-center px-4 py-2 text-sm font-medium text-white bg-blue-600 border border-transparent rounded-md shadow-sm hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">Advance
                        to offer</button>
                </div>
            </div>
        </section>
