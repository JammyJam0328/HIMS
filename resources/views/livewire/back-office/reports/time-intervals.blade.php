<div x-data>
  <div class="flex items-center justify-between">
    ...
    <div class="flex space-x-1">
      <x-button.primary @click="printOut($refs.printContainer.outerHTML);"> Print </x-button.primary>
    </div>
  </div>
  <div class="p-5 mt-5 border-2">
    <div x-ref="printContainer" id="print" class="flex flex-col mt-5">
      ...
      <table id="example" class="mt-5 table-auto" style="width:100%">
        <thead class="font-normal">
          <tr>
            <th width="150" class="px-2 py-2 text-sm font-semibold text-left text-gray-700 border border-gray-700">
            </th>
        ...
        <tbody class="">
          @foreach ($room_checkin_intervals as $roomId => $room_checkin_interval)
            <tr>
              <td colspan="4" class="px-3 py-1 font-bold text-gray-700 bg-gray-100 border border-gray-700">
