<div x-data="{ showRequestForm: false }"
    x-on:close-form.window="showRequestForm=false">
    <x-content>
        ...
        <div wire:key="guest">
            @if ($guest)
                <div id="9091873ashdjashduiy128372891">
                    <div x-show="!showRequestForm"
                        id="view"
                        class="grid w-full gap-5">
                        <div class="flex justify-end col-span-12">
                            <x-button.primary x-on:click="showRequestForm=true">
                                Request Amenities
                            </x-button.primary>
                        </div>
                    ...
                    <div x-cloak
                        ...
                        <div x-data="{ excessAmountFromPreviousPayment: $wire.entangle('excessAmountFromPreviousPayment') }"
                                ...
                                <div class="grid items-start grid-cols-2 gap-4">
                                    <div class="grid col-span-1 gap-4">
                                        ...
                                        <div class="grid gap-1">
                                            <x-input-label value="Select Amenity" />
                                            <x-select wire:model="amenityId">
                            ...
                            <div class="mt-5 flex justify-end space-x-3 rounded-b-lg border-t bg-white p-2.5">
                                <x-button.danger x-on:click="showRequestForm = false">Close Form</x-button.danger>
                                <x-button.primary x-on:click.prevent="$dispatch('confirm-request')">
                                    Save
                                </x-button.primary>
                            </div>
                        </div>
