    ...
    <div class="mt-5 border-t border-gray-200">
      <dl class="divide-y divide-gray-200">
        <div class="py-4 sm:grid sm:grid-cols-3 place-content-center sm:gap-4 sm:py-5">
          <dt class="text-sm font-medium text-gray-600 uppercase">Name</dt>
        ...
        <div class="py-4 sm:grid sm:grid-cols-3 place-content-center sm:gap-4 sm:py-5">
          <dt class="text-sm font-medium text-gray-600 uppercase">Price</dt>
        ...
        <div class="py-4  sm:py-5">
          <h1 class="font-bold text-green-700 text-xl">MANAGE STOCKS FOR THIS MENU</h1>

          <div class="py-4 sm:grid sm:grid-cols-3 place-content-center mt-3 sm:gap-4 sm:py-5">
            <dt class="text-sm font-medium text-gray-600 uppercase">Stocks</dt>
            <dd class="flex text-sm text-gray-900 sm:col-span-2 sm:mt-0">
              <div class="">
          ...
          <div class="py-4 border-t sm:grid sm:grid-cols-3 place-content-center sm:gap-4 sm:py-5">
            <dt class="text-sm font-medium text-gray-600 uppercase">Servings</dt>
            <dd class="flex text-sm text-gray-900 sm:col-span-2 sm:mt-0">
              <div class="">
