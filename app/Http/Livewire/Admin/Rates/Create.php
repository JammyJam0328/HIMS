...
class Create extends Component
{
    ...
    public function rules()
    {
        return [
            ...
            // staying hour id must be unique in each type in the same branch
            'rate.staying_hour_id' => 'required|in:'.$this->stayingHours->pluck('id')->implode(',').'|unique:rates,staying_hour_id,NULL,id,type_id,'.$this->rate->type_id.',branch_id,'.auth()->user()->branch_id,
    ...
    public function mount()
    {
        ...
        $this->rate = Rate::make(['branch_id' => $branchId]);
    }
